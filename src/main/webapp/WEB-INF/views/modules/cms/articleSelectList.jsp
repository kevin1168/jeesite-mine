	...
	<div id="myCarousel" class="carousel slide">
	    ...
	    <div class="carousel-inner">
	        <div class="item active">
	            <img src="/jeesite/userfiles/1/images/photo/2017/09/1.jpg" alt="First slide">
	        </div>
	        <div class="item">
	            <img src="/jeesite/userfiles/1/images/photo/2017/09/2.jpg" alt="Second slide">
	        </div>
	        <div class="item">
	            <img src="/jeesite/userfiles/1/images/photo/2017/09/3.jpg" alt="Third slide">
	        </div>
	    </div>
	    <!-- 轮播（Carousel）导航 -->
